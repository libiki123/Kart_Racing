...
public class GoKart_Backup : MonoBehaviour
{
	...
	//	get
	//	{
	//		return backupVelocity_;
	//	}
	//	set
	//	{
	//		backupVelocity_ = value;
	//	}
	//}
	...
	//	get
	//	{
	//		return m_extern.dragFactor;
	//	}
	//	set
	//	{
	//		m_extern.dragFactor = value;
	//	}
	//}
	...
	//	get
	//	{
	//		return m_extern.compensationDragFactor;
	//	}
	//	set
	//	{
	//		m_extern.compensationDragFactor = value;
	//	}
	//}
	...
	//		ProcessDriftGauge(fixedDeltaTime);
	...
	//{
	//	//return m_ctrl.steerAngle * 180f / (float)Mathf.PI;
	//	return 0;
	//}

	//public float getRealSteer()
	//{
	//	//return m_ctrl.getRealSteer();
	//	return 0;
	//}

	//public float getRealAccel()
	//{
	//	//return m_ctrl.getRealAccel();
	//	return 0;
	//}

	//public float getRealBrake()
	//{
	//	//return m_ctrl.getRealBrake();
	//	return 0;
	//}
	...
	//{
	//	//return m_kart.transform.TransformPoint(wheelLocalPos_[i]);
	//	return Vector3.zero;
	//}
	...
	//	//}
	//	//if (isZoneBoost(kind) || m_ctrl.getRealAccel() != 0f)
	//	//{
	//	//	m_boostLeft = time;
	//	//	m_BoostKind = kind;
	//	//}
	...
	//public bool isItemBoost()
	//{
	//	//return isItemBoost(m_BoostKind);
	//	return false;
	//}

	//public bool isItemBoost(BoostKind kind)
	//{
	...
	//{
	//	//return m_KartWLVel.magnitude * 3.6f;
	//	return 0;
	//}

	//public float GetKartRealSpeed()
	//{
	//	//return m_KartRealVelocity.magnitude * 3.6f;
	//	return 0;
	//}
	...
	//public void Warp(Vector3 pos, Quaternion rot, bool flush, bool resetVel)
	//{
	//	//m_kart.transform.localPosition = pos;
	//	//m_kart.transform.localRotation = rot;
	//	//if (flush)
	//	//{
	//	//}
	//	//if (resetVel)
	...
	//{
	//	//return m_spec.driftMaxGauge;
	//	return 0;
	//}

	//public float GetDriftGauge()
	//{
	//	//return m_driftGauge.gauge;
	//	return 0;
	//}

	//public float GetDriftGaugeProgress()
	//{
	//	//return Mathf.Min(m_spec.driftMaxGauge, m_driftGauge.gauge + m_driftGauge.progress);
	//	return 0;
	//}

	//public bool UseDriftGauge(float gauge)
	//{
	//	//if (gauge > m_driftGauge.gauge)
	//	//{
	//	//	return false;
	//	//}
	//	//m_driftGauge.gauge -= gauge;
	//	//return true;
	//	return true;
	//}
	...
	//{
	//	//float lastProgress = m_driftGauge.lastProgress;
	//	//m_driftGauge.lastProgress = 0f;
	//	//return lastProgress;
	//	return 0;
	//}
	...
	//{
	//	//if (m_driftGauge.progressOn && m_Contact && m_first.frontVel >= 0f)
	//	//{
	//	//	m_driftGauge.progressTime += deltaT;
	//	//	if (m_driftGauge.progressTime < 0.2f)
	//	//	{
	//	//		m_driftGauge.progress += 2f * deltaT * m_first.leftVel * m_first.leftVel * 3f;
	//	//	}
	//	//	else if (m_driftGauge.progressTime < 0.5f)
	//	//	{
	//	//		m_driftGauge.progress += 2f * deltaT * m_first.leftVel * m_first.leftVel * 1.5f;
	//	//	}
	//	//	else
	//	//	{
	//	//		m_driftGauge.progress += 2f * (deltaT * m_first.leftVel * m_first.leftVel) / (m_driftGauge.progressTime * 2f);
	//	//	}
	//	//}
	//}
	...
	//public bool IsAccel()
	//{
	//	//return m_ctrl.getRealAccel() > 0f;
	//	return false;
	//}

	//public bool IsBrake()
	//{
	//	//return m_ctrl.getRealBrake() > 0f;
	//	return false;
	//}

	//public int GetNormalBoosterTime()
	//{
	//	//return (!(m_spec.normalBoosterTime < 0f)) ? ((int)m_spec.normalBoosterTime) : 0;
	//	return 0;
	//}
